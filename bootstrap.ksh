...
su root -c 'pkg_add -zm vim git ranger pcmanfm irssi feh compton firefox iridium thunderbird gimp inkscape zip unzip bitlbee xpdf ranger rxvt-unicode scrot wget expect cadaver curl gtar bash ruby ruby-gems; vim /etc/X11/xdm/Xsetup_0 -c "%s/xconsole/\#xconsole" -c "wq"; visudo; exit'
cd ~
