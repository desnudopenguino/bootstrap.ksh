...
su root -c 'pkg_add -Im sudo vim git i3 ranger pcmanfm irssi feh compton firefox iridium thunderbird gimp inkscape zip unzip bitlbee xpdf ranger rxvt-unicode scrot wget expect cadaver; exit'
cd ~
